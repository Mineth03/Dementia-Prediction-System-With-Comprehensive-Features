...
const requiredFieldsBySection = {
  ...
  5: ["DIABET", "HYPERTEN", "HYPERCHO", "THYDIS", "CVANGINA","CVCHF", "CVHATT", "CVAFIB", "TIA", "STROKE", "TBI"], // Health Conditions
...
try {
  const response = await fetch("http://127.0.0.1:5000//predict_sev", {
    method: "POST",
    headers: {
