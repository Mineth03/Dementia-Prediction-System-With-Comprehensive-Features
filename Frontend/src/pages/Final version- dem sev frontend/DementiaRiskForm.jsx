...
const requiredFieldsBySection = {
  ...
  2: ["DEM_TYPE","height", "weight","HRATE", "VB12DEF","VISIMP", "HEARING", "MOT" ,"FOCL_STATUS"], // Current Health Status
...
const calculateSleepDysfunction = () => {
  ...
  <div className="flex-1">
    ...
    {errors.weight && <p className="text-red-500">{errors.weight}</p>}
            ...
            <RequiredLabel text="Does the patient have hearing difficulties?" />
              ...
              {errors.HEARING && <p className="text-red-500">{errors.HEARING}</p>}
            </div>
            ...
            <div>
              ...
              <RequiredLabel text="Does the patient experience any motor function issues?" />
                ...
                {errors.MOT && <p className="text-red-500">{errors.MOT}</p>}
              </div>
  ...
  {errors.SPEECH && <p className="text-red-500">{errors.SPEECH}</p>}
            ...
            <div className="space-y-2 mb-4">
              <RequiredLabel text="Has the patient experienced bowel incontinence (loss of bowel control)?" />
        ...
        {currentSection === 5 && (
          <div>
            ...
            <div className="space-y-2 mb-4">
              ...
              {errors.TBI && <p className="text-red-500">{errors.TBI}</p>}
            </div>
...
{(formData.TBI === "1" || formData.TBI === "2") && (
  <div className="space-y-2 mb-4">
    ...
    <p className="text-gray-600 text-sm">
      <b>Loss of Consciousness (LOC)</b> means the patient fainted or blacked out due to the head injury.  
...
<RequiredLabel text="Seizures:" />  
  <select name="SEIZURES" value={formData.SEIZURES || ""} onChange={handleChange} required className={getInputClassName("SEIZURES")}>
    <option value="">Select</option>
    ...
    {errors.SEIZURES && <p className="text-red-500">{errors.SEIZURES}</p>}
        ...
        {currentSection === 8 && (  
          <div>
            ...
            <div className="space-y-2 mt-4">
  <RequiredLabel text="Enter the patient's cognitive score (MoCA - Montreal Cognitive Assessment):" />
  <input
    type="number"
    name="NACCMOCA"
    value={formData.NACCMOCA || ""}
    onChange={handleChange}
    required
    className={getInputClassName("NACCMOCA")}
  />
    ...
    {medicationQuestions.map((med, index) => {
      ...
      return (
        <div key={index} className="mb-4">
          ...
          <div className="flex justify-between mt-2 px-6 space-x-2">
